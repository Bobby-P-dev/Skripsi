...
<div class="md:hidden p-4 border-r">
    ...
    <div class="flex flex-col justify-center items-center gap-6 mt-8">
        ...
        <a href="{{ route('laporan.admin') }}" class="block rounded {{ request()->segment(2) == 'laporan' ? 'border-b-4 border-blue-700' : 'hover:bg-blue-0' }}">    
            <div class="w-8 h-8">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 300" xml:space="preserve"><path d="m221.615 93.924.001-.001-39.891-39.891a5.162 5.162 0 0 0-3.662-1.518H82.045a5.179 5.179 0 0 0-5.178 5.178v184.616a5.177 5.177 0 0 0 5.178 5.177h135.909a5.176 5.176 0 0 0 5.178-5.177V97.584a5.251 5.251 0 0 0-1.517-3.66zm-8.838 143.207H87.222V62.87h88.698l29.537 29.537H183.24V81.588a5.177 5.177 0 0 0-10.354 0v15.996a5.174 5.174 0 0 0 5.176 5.177l34.714.001v134.369z"/><path d="m122.876 104.546-10.317 10.317-1.475-1.475a5.18 5.18 0 0 0-7.323 0 5.175 5.175 0 0 0 0 7.322l5.137 5.136a5.172 5.172 0 0 0 7.321 0l13.979-13.979a5.178 5.178 0 0 0-7.322-7.321zM190.86 127.364h1.721a5.179 5.179 0 0 0 0-10.356h-1.721a5.178 5.178 0 1 0 0 10.356zM141.559 117.008a5.18 5.18 0 1 0 0 10.356h33.552a5.177 5.177 0 1 0 0-10.356h-33.552zM190.86 159.204h1.721a5.177 5.177 0 1 0 0-10.355h-1.721a5.177 5.177 0 1 0 0 10.355zM175.111 148.85h-33.552a5.178 5.178 0 1 0 0 10.355h33.552a5.178 5.178 0 1 0 0-10.355zM190.86 191.045h1.721a5.18 5.18 0 0 0 0-10.356h-1.721a5.177 5.177 0 1 0 0 10.356zM175.111 180.69h-33.552a5.18 5.18 0 1 0 0 10.356h33.552a5.178 5.178 0 1 0 0-10.356zM190.86 222.885h1.721a5.178 5.178 0 0 0 0-10.355h-1.721a5.177 5.177 0 1 0 0 10.355zM175.111 212.531h-33.552a5.179 5.179 0 1 0 0 10.355h33.552a5.178 5.178 0 1 0 0-10.355zM112.558 159.204c1.372 0 2.69-.546 3.66-1.517l13.979-13.979a5.178 5.178 0 0 0-7.321-7.322l-10.317 10.317-1.475-1.475a5.178 5.178 0 0 0-7.323 7.321l5.137 5.137a5.17 5.17 0 0 0 3.66 1.518zM107.089 178.878l-3.329 3.329a5.18 5.18 0 0 0 3.662 8.838 5.165 5.165 0 0 0 3.661-1.516l3.327-3.33 3.329 3.33a5.161 5.161 0 0 0 3.661 1.516 5.175 5.175 0 0 0 3.66-8.838l-3.329-3.329 3.329-3.329a5.178 5.178 0 0 0-7.323-7.321l-3.327 3.327-3.327-3.327a5.178 5.178 0 0 0-7.323 7.321l3.329 3.329zM122.876 200.067l-10.317 10.318-1.475-1.474a5.177 5.177 0 0 0-7.323 0 5.175 5.175 0 0 0 0 7.322l5.137 5.136a5.175 5.175 0 0 0 7.321 0l13.979-13.98a5.178 5.178 0 0 0-7.322-7.322z"/></svg>
            </div>
        </a>
        <a href="{{ route('data.admin') }}" class="block rounded {{ request()->segment(2) == 'data' ? 'border-b-4 border-blue-700 p-1' : 'hover:bg-blue-0' }}">
            <div class="w-5 h-5">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" style="enable-background:new 0 0 32 32" xml:space="preserve"><path d="M30.625 12.914H20.254a1 1 0 1 1 0-2h10.371a1 1 0 1 1 0 2zM30.625 20.293h-6.844a1 1 0 1 1 0-2h6.844a1 1 0 1 1 0 2zM30.625 27.672h-4.336a1 1 0 1 1 0-2h4.336a1 1 0 1 1 0 2z"/><g><path d="M12.375 14c-3.86 0-7-3.14-7-7s3.14-7 7-7 7 3.14 7 7-3.14 7-7 7zm0-12c-2.757 0-5 2.243-5 5s2.243 5 5 5 5-2.243 5-5-2.243-5-5-5zM20.317 32H4.433a4.062 4.062 0 0 1-4.058-4.058c0-6.616 5.383-12 12-12s12 5.384 12 12A4.062 4.062 0 0 1 20.317 32zm-7.942-14.058c-5.514 0-10 4.486-10 10A2.06 2.06 0 0 0 4.433 30h15.884a2.06 2.06 0 0 0 2.058-2.058c0-5.514-4.486-10-10-10z"/></g></svg>
            </div>
        </a>
        <a href="{{ route('penugasan.index') }}" class="block rounded {{ request()->segment(2) == 'penugasan' ? 'border-b-4 border-blue-700 p-1' : 'hover:bg-blue-0' }}">
            <div class="w-5 h-5">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64"><path d="M61.222 2.778a9.485 9.485 0 0 0-13.414 0L6.293 44.293a1.002 1.002 0 0 0-.242.39l-6 18a1 1 0 0 0 1.265 1.266l18-6a1.002 1.002 0 0 0 .391-.242l41.515-41.515a9.496 9.496 0 0 0 0-13.414zM54 20.586 43.414 10 45 8.414 55.586 19zM20.012 54.573l-4.457-.133-.133-4.448L48 17.414 52.586 22zM9.555 48.44l-.129-4.451L42 11.414 46.586 16 14.017 48.569zm-2.052-1.785.08 2.786a1 1 0 0 0 .97.97l4.632.136a.477.477 0 0 0 .26.262l.138 4.633a1 1 0 0 0 .97.97l2.8.084-7.243 2.414a10.048 10.048 0 0 0-5.02-5.019zm-3.046 9.137a8.051 8.051 0 0 1 3.752 3.752L2.58 61.419zm55.35-41.013L57 17.586 46.414 7l2.808-2.808a7.485 7.485 0 1 1 10.586 10.586z" style="fill:#1b1a1e"/><path d="M54.514 2.999a6.44 6.44 0 0 0-4.585 1.9 1 1 0 0 0 1.414 1.414 4.484 4.484 0 0 1 6.343 0A1 1 0 1 0 59.101 4.9a6.44 6.44 0 0 0-4.587-1.9z" style="fill:#1b1a1e"/></svg>
            </div>
        </a>
        <a href="">
            <div class="w-6 h-6">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 6.827 6.827"><g id="Layer_x0020_1"><path class="fil0" d="M1.1.96h4.627c.047 0 .089.019.12.05h-.001c.03.03.05.072.05.118v3.568a.168.168 0 0 1-.168.168H4.605l.204-.207h.879v-3.49H1.138v3.49h2.451l-.204.207H1.1a.168.168 0 0 1-.168-.168V1.128c0-.046.019-.088.05-.119.03-.03.072-.049.118-.049z"/><path class="fil0" d="M1.387 4.078a.107.107 0 0 0 .151.15l1.27-1.268.958.958a.107.107 0 0 0 .15-.15L2.884 2.734a.107.107 0 0 0-.151 0L1.387 4.077z"/><path class="fil0" d="M3.3 3.302a.107.107 0 0 0 .152.151l.878-.878.958.959a.107.107 0 0 0 .151-.151L4.406 2.349a.107.107 0 0 0-.152 0l-.953.953zM2.187 1.564a.519.519 0 0 1 .368.889.519.519 0 0 1-.889-.368.519.519 0 0 1 .52-.52zm.217.304a.306.306 0 0 0-.524.217.306.306 0 0 0 .524.217.306.306 0 0 0 0-.434zM3.481 5.023l.364.358-.149.152-.364-.359zM4.69 3.794l.365.359-.15.151-.363-.358z"/><path class="fil0" d="m3.815 5.55-.666.317-.139-.136.302-.674.021-.03 1.44-1.463a.259.259 0 0 1 .128-.072.17.17 0 0 1 .158.042l.25.246a.17.17 0 0 1 .045.158.259.259 0 0 1-.07.13l-1.44 1.461-.03.021zm-.502.01.397-.189 1.426-1.448a.07.07 0 0 0 .01-.013l-.214-.211a.071.071 0 0 0-.013.01L3.493 5.159l-.18.402z"/></g><path style="fill:none" d="M0 0h6.827v6.827H0z"/></svg>
            </div>
        </a>
        @endif
