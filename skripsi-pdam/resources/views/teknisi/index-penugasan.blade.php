        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white shadow-md rounded-xl overflow-hidden hover:shadow-lg transition flex flex-col justify-between h-full">
                ...
                <div class="h-48 w-full overflow-hidden">
                    <img src="{{ $penugasan->laporan->foto_url ?? 'kaga ada' }}"
                ...
                <div class="p-6 flex-1 flex flex-col justify-between">
                    <div>
                        <div class="mb-4">
                            ...
                            <p class="text-gray-800 text-sm break-all">{{ $penugasan->laporan->lokasi }}</p>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <h2 class="text-sm font-semibold text-gray-600">Lokasi</h2>
                            <p class="text-gray-700">{{ $penugasan->laporan->lokasi}}</p>
                        </div>
                    </div>
