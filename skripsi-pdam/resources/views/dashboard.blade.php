    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl shadow p-6 flex flex-col gap-4">
                ...
                <a href="{{ route('laporan.admin') }}" class="inline-flex items-center gap-2 rounded-lg border border-green-500 bg-green-50 text-green-600 hover:bg-green-100 px-4 py-2 text-sm font-semibold shadow transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M4 17l6-6 4 4 8-8" />
                    </svg>
                    Lihat Laporan Masuk
                </a>
                <a href="{{ route('alllaporan.index') }}" class="inline-flex items-center gap-2 rounded-lg border border-yellow-500 bg-yellow-50 text-yellow-600 hover:bg-yellow-100 px-4 py-2 text-sm font-semibold shadow transition">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3" />
                        <circle cx="12" cy="12" r="10" />
                    </svg>
